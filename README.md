...
- **Dev Server URL**: `http://127.0.0.1:5235`
- **Preview URL**: `https://api.chitterchat.co.uk/chipify/projects/3d5daac7-7094-4a04-8d16-4c6316f724b6/preview`
- **Port**: `5235`
...
4. The dev server is accessible at `http://127.0.0.1:5235`
5. Preview the application using the preview URL: `https://api.chitterchat.co.uk/chipify/projects/3d5daac7-7094-4a04-8d16-4c6316f724b6/preview`
